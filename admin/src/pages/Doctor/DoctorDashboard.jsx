...
const DoctorDashboard = () => {
  ...
  const { doctorToken, dashboardStats, setDashboardStats, fetchDashboardStats, completeAppointment, cancelAppointment } = useContext(DoctorContext)
    ...
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-x1 font-semibold text-gray-600'>{currencySymbol} {dashboardStats.earnings}</p>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-x1 font-semibold text-gray-600'>{dashboardStats.patientCount}</p>
        ...
        <div className='pt-4 border border-t-0'>
          {
            dashboardStats.latestAppointments.map((item, index) => (
              <div className='flex items-center px-6 py-3 hover:bg-gray-100' key={index}>
                <img className='rounded-full w-10' src={item.user.imageUrl} alt="" />
